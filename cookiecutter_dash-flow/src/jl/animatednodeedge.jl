...
export animatednodeedge

"""
    animatednodeedge(;kwargs...)
...
"""
function animatednodeedge(; kwargs...)
        available_props = Symbol[:id, :data, :sourcePosition, :sourceX, :sourceY, :targetPosition, :targetX, :targetY]
        wild_props = Symbol[]
        return Component("animatednodeedge", "AnimatedNodeEdge", "dash_flows", available_props, wild_props; kwargs...)
end
